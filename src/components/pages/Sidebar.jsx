...
import { getUserInfo, postUserInfo } from "../../redux/modules/userSlice";
...
export default function Sidebar() {
  ...
  const onFileChangeHandler = (e) => {
    ...
    fileReader.onload = async () => {
      ...
      let Data = dataURLtoFile(img, "hello.txt");
      console.log(Data);
      await dispatch(
        postUserInfo({
          img,
        ...
        <div className="profile_wrapper">
          <StProfile>
            <label htmlFor="file_item" className="profile_label">
              <span className=""></span>
              {img && <img src={img} alt="" id="profile_img" />}
            </label>
            <input
              type="file"
              hidden
          ...
          <div className="writing_btn_container">
            <StWritingbtn className="writing_btn">글쓰기</StWritingbtn>
          </div>
        </div>
